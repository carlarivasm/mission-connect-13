        ...
        <AuthProvider>
          <AppSettingsProvider>
            ...
            <Routes>
              ...
              <Route path="/materiais" element={<ProtectedRoute requireApproval><Materiais /></ProtectedRoute>} />
              <Route path="/galeria" element={<ProtectedRoute requireApproval><Galeria /></ProtectedRoute>} />
