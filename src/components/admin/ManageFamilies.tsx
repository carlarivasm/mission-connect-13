...
import { Download, ChevronDown, ChevronRight, UserPlus, Users, Search, Heart, User } from "lucide-react";
                  ...
                  >
                    <div>
                      ...
                      <div className="flex items-center gap-1 mt-1 text-xs text-muted-foreground">
                        <User size={12} /> Responsável: <span className="font-medium text-foreground">{f.creatorName}</span>
                      </div>
                    </div>
                    <div className="flex items-center justify-between sm:justify-end text-muted-foreground">
                      <span className="text-xs sm:hidden">Toque para expandir</span>
                      {expandedFamily === f.id ? <ChevronDown size={18} /> : <ChevronRight size={18} />}
                    </div>
                  </div>
